/* 
g++ drill12.cpp ../GUI/Graph.cpp ../GUI/Window.cpp ../GUI/GUI.cpp ../GUI/Simple_window.cpp -o main `fltk-config --ldflags --use-images`
...
int main()
{
	try 
	{
		...
		poly_rect.add(Point{200,10});
		poly_rect.add(Point{100,10});
